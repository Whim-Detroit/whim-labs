...
awk -v opc_api=${opc_api_var} -v opc_user=${opc_user_var} -f /tmp/scripts/oracle/7.3/config_ol73_oracle_opc_cli.awk /tmp/scripts/oracle/7.3/users/user-vagrant-bashrc.sh > .bashrc.${curdate}.opc-cli
